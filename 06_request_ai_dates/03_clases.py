# 1.Introducion a las Clasese en Python
...
# se llama automáticamente este método cuando creas la instancia
    ...
    def arrancar(self):
        print(f"El coche {self.marca} {self.modelo} arracó!")


mi_coche = Coche("porche", "911 carrera", "negro")
mi_coche.arrancar()

print(mi_coche.marca)

otro_Coche = Coche("Toyota", "Corola", "rojo")
otro_Coche.arrancar()
