...
op = input("introduzca la opracion que desea realizar: ")

n1 = float(input("introduzca otro numero: "))

if op == "+" :
  print( "elresultado es: ", n + n1)
elif op == "-":
  print("elresultado es: ", n - n1)
elif op == "*":
  print( "elresultado es: ", n * n1)
 ...
 if n1 == 0:
   print(" Error no se puede devidir entre 0")
 else:
    print( "elresultado es: ", n / n1)
...
ano = int(input("introduce un anyo: "))

if(ano % 4 == 0 and ano % 100 !=0) or ano % 400 == 0:
   print(f"{ano} es un anyo bisiesto")
else:
   print(f"{ano} no es un anyo bisiesto")
